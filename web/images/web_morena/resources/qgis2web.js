...
var map = new ol.Map({
    ...
    var searchLayer = new ol.SearchLayer({
      layer: lyr_areas_geoestadisticas_estatales0,
      colName: 'afiliados_PRI',
      zoom: 10,
      collapsed: true,
      map: map
    });
...
map.getView().fit([-12981888.450194, 1011130.260462, -9311950.443419, 4275671.900527], map.getSize());
